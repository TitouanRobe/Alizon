    ...
    <main class="main-vendeur">
        ...
        <?php
         if(isset($_POST["nomProduit"])) {
            inserer_produit(array($_POST["nomProduit"],$_POST["prixCT"] ,$_POST["prixHT"], $_POST["quantite"], $_POST["description"],null,null,null, getID_Souscategorie($_POST["souscategorie"]),$_SESSION["vendeur"]));
         }
         unset($_POST);
           ?>
